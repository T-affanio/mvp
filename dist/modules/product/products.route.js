...
// 🔐 todas protegidas
exports.productRoutes.use(ensureAuth_1.ensureAuth);
...
exports.productRoutes.post("/", ensureAuth_1.ensureAuth, upload.array("images", 3), controller.create.bind(controller));
